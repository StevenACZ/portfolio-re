...
const TechIcons = {
  ...
  html: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="M4.136 3.012h15.729l-1.431 16.15-6.451 1.826-6.414-1.826-1.433-16.15Zm12.451 5.062H7.915l.247 2.754h8.177l-.748 8.23-3.592.996-3.593-.993-.247-2.754h2.716l.127 1.404 1.004.273.997-.273.127-1.404h-4.716l-.496-5.486h8.694l-.249 2.754h-5.19" />
    </svg>
  ),
  css: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="M4.192 3.143h15.615l-1.42 16.034-6.404 1.812-6.369-1.813L4.192 3.143Zm4.838 7.65 1.116.526c.238-.238.509-.393.813-.463.305-.07.584-.035.838.103.254.139.41.39.466.756.056.366-.008.812-.192 1.336l1.238.308c.298-.748.37-1.428.214-2.04-.155-.612-.531-1.064-1.127-1.354a2.497 2.497 0 0 0-1.728-.144c-.58.126-1.074.386-1.483.78l-.156.192Zm3.686 1.89-1.116-.527c-.238.239-.509.394-.813.464-.305.07-.584.034-.838-.104-.254-.139-.41-.39-.466-.755-.056-.366.008-.812.192-1.336l-1.238-.309c-.298.749-.37 1.429-.214 2.041.155.612.531 1.063 1.127 1.354.571.28 1.144.327 1.728.143.58-.126 1.074-.386 1.483-.78l.156-.191Z" />
    </svg>
  ),
  // Backend
  nodejs: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="M11.998 24c-.321 0-.641-.084-.922-.247L8.14 22.016c-.438-.245-.224-.332-.08-.383.658-.229.792-.281 1.494-.679.074-.042.17-.026.244.017l2.255 1.339c.082.045.198.045.275 0l8.79-5.076c.083-.047.136-.142.136-.241V6.921c0-.102-.053-.197-.14-.245l-8.783-5.07c-.081-.047-.191-.047-.272 0L3.27 6.676c-.087.049-.139.147-.139.247v10.073c0 .097.052.191.136.239l2.409 1.392c1.307.653 2.108-.116 2.108-.89V7.787c0-.142.114-.253.256-.253h1.115c.139 0 .255.112.255.253v9.95c0 1.744-.95 2.745-2.604 2.745-.509 0-.909 0-2.026-.55l-2.304-1.327A1.852 1.852 0 0 1 1.5 17.14V7.067c0-.66.353-1.277.922-1.607L11.21.384a1.925 1.925 0 0 1 1.846 0l8.79 5.076c.57.33.921.946.921 1.607v10.073c0 .66-.351 1.277-.92 1.607l-8.79 5.076a1.9 1.9 0 0 1-.923.247l-.136.03z" />
    </svg>
  ),
  express: (
    <svg viewBox="0 0 24 24" fill="currentColor">
  ...
  graphql: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="m12.002 0 10.392 6v12L12.002 24 1.61 18V6L12.002 0ZM4.073 7.404v8.192l7.929 4.58 7.929-4.58V7.404L12.002 2.82 4.073 7.404Zm7.929 1.392a3.203 3.203 0 1 1 0 6.407 3.203 3.203 0 0 1 0-6.407Z" />
    </svg>
  ),
  // Mobile
  swift: (
  ...
  vite: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="m8.286 10.578.512-8.657a.306.306 0 0 1 .247-.282L17.377.006a.306.306 0 0 1 .353.385l-1.558 5.403a.306.306 0 0 0 .352.385l2.388-.46a.306.306 0 0 1 .332.438l-6.79 13.55-.123.19a.294.294 0 0 1-.252.14c-.177 0-.35-.152-.305-.369l1.095-5.301a.306.306 0 0 0-.388-.355l-1.433.435a.306.306 0 0 1-.389-.354l.69-3.375a.306.306 0 0 0-.37-.36l-2.32.536a.306.306 0 0 1-.374-.316l.255-2.95Z" />
    </svg>
  ),
  figma: (
    <svg viewBox="0 0 24 24" fill="currentColor">
...
// Skills data organized by category with colors
const skillsData = [
  { name: "React", icon: "react", category: "frontend", color: "#61DAFB" },
  { name: "Vue.js", icon: "vue", category: "frontend", color: "#4FC08D" },
  { name: "Nuxt", icon: "nuxt", category: "frontend", color: "#00DC82" },
  {
    name: "TypeScript",
    icon: "typescript",
    category: "frontend",
  ...
  { name: "Astro", icon: "astro", category: "frontend", color: "#FF5D01" },
  { name: "Node.js", icon: "nodejs", category: "backend", color: "#339933" },
  { name: "Express", icon: "express", category: "backend", color: "#FFFFFF" },
  {
    name: "PostgreSQL",
    icon: "postgresql",
    category: "backend",
  ...
  { name: "Prisma", icon: "prisma", category: "backend", color: "#2D3748" },
  { name: "MongoDB", icon: "mongodb", category: "backend", color: "#47A248" },
  { name: "Swift", icon: "swift", category: "mobile", color: "#F05138" },
  { name: "SwiftUI", icon: "swiftui", category: "mobile", color: "#0071E3" },
  ...
  { name: "Vite", icon: "vite", category: "tools", color: "#646CFF" },
  { name: "Figma", icon: "figma", category: "tools", color: "#F24E1E" },
  { name: "GitHub", icon: "github", category: "tools", color: "#FFFFFF" },
];
