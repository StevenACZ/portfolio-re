export const FRONTEND_TECH_ICON_DEFS = {
  react: {
    svgAttrs: {
      viewBox: "0 0 24 24",
      fill: "currentColor",
    ...
    nodes: [
      {
        tag: "path",
        attrs: {
          d: "M2 3h3.5L12 13.5 18.5 3H22L12 21 2 3Zm5 0h3l2 3.5L14 3h3l-5 8.5L7 3Z",
        },
      },
    ],
  },
    ...
    nodes: [
      {
        tag: "path",
        attrs: {
          d: "M13.4 21H3.6c-.5 0-1-.1-1.4-.4-.4-.3-.7-.6-.9-1.1-.2-.5-.2-1-.1-1.5.1-.5.4-.9.7-1.3l6-10c.3-.4.6-.8 1.1-1 .5-.2 1-.2 1.5-.1.5.1.9.4 1.2.8l2.3 3.8 2.3-3.8c.3-.4.7-.7 1.2-.8.5-.1 1-.1 1.5.1.5.2.8.6 1.1 1l4.3 7c.3.4.5.8.6 1.3.1.5 0 1-.2 1.5-.2.5-.5.8-.9 1.1-.4.3-.9.4-1.4.4h-4.6l-4.5-7.4-4.5 7.4Z",
        },
      },
    ],
  },
